...
export default function NewQuotePage() {
  ...
  const renderItemsTable = (
    ...
    <div className="space-y-3">
      ...
      <div className="max-w-full overflow-x-auto overscroll-x-contain rounded-xl border border-slate-200 bg-slate-50/70 dark:border-slate-800 dark:bg-slate-900/60">
